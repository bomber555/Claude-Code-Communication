...
### 🎯 あなたのプロジェクトにCCCを導入する場合

**👉 [QUICK_INSTALL.md](./QUICK_INSTALL.md) のプロンプトをClaude Codeで実行してください**

簡単なプロンプト一つで、あなたのプロジェクトにCCCマルチエージェント協調システムが導入されます！

### 🧪 CCCをテスト・体験する場合

以下の手順でCCC単体での動作確認ができます：
